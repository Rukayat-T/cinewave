...
function page() {
    ...
    return (
        ...
        <div className="bg-white min-w-[28vw] min-h-[50vh] mr-[18vw] rounded-xl p-[3rem]">
            ...
            <form action="" className=" flex flex-col gap-y-5">
                ...
                <input type="button" value={"Log In"} className="h-[4vh] bg-slate-500 text-white text-[1.2rem] mt-5 rounded-md" />
            </form>
            </div>
        </div>
        </div>
